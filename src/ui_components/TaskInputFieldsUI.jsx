...
export const TaskInputFieldsUI = (props) => {
    return (
        <div className={props.classes.taskInputFields__wrapper}>
            ...
            <TaskInput actionForInputFieldsValuesForNewTaskReducer={taskDeadlineAction.type} labelName='Срок' initialValueInInput={props.editableTaskObject && props.editableTaskObject.taskDeadline} taskFieldIdentifier={allSignsForTasksFilter.taskDeadline.variable} obligatoryField={false}></TaskInput>
            <TaskInput actionForInputFieldsValuesForNewTaskReducer={taskDurationAction.type} labelName='Продолжительность' initialValueInInput={props.editableTaskObject && props.editableTaskObject.taskDuration} taskFieldIdentifier={allSignsForTasksFilter.taskDuration.variable} obligatoryField={false}></TaskInput>
            <TaskInput actionForInputFieldsValuesForNewTaskReducer={taskStatusAction.type} labelName='Статус' initialValueInInput={props.editableTaskObject && props.editableTaskObject.taskStatus} taskFieldIdentifier={allSignsForTasksFilter.taskStatus.variable} obligatoryField={true} initialSignPropertyValueForNewTask={'-'}></TaskInput>
