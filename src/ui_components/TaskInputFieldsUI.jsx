...
export const TaskInputFieldsUI = (props) => {
    return (
        <div className={props.classes.taskInputFields__wrapper}>
            ...
            <TaskInput actionForInputFieldsValuesForNewTaskReducer={taskUrgencyAction.type} labelName='Срочность' initialValueInInput={props.editableTaskObject && props.editableTaskObject.taskUrgency} taskFieldIdentifier={allSignsForTasksFilter.taskUrgency.variable} obligatoryField={false}></TaskInput>
            <TaskInput actionForInputFieldsValuesForNewTaskReducer={taskImportanceAction.type} labelName='Важность' initialValueInInput={props.editableTaskObject && props.editableTaskObject.taskImportance} taskFieldIdentifier={allSignsForTasksFilter.taskImportance.variable} obligatoryField={false}></TaskInput>
